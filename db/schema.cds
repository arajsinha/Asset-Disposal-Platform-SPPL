...
entity RequestDetails : cuid, managed
{
    ...
    assetDetails : Composition of many AssetDetails on assetDetails.requestDetails = $self;
    objectId : String(14);
    RequestStatus : Association to one RequestStatus;
    AuditTrail : Association to many AuditTrail on AuditTrail.requestDetails = $self;
    workflows: Composition of many Workflows on workflows.requestDetails = $self;  // One RequestDetails can have many Workflows
...
entity Workflows : cuid, managed {
    ...
    auditTrail: Composition of many AuditTrail on auditTrail.workflows = $self;  // One Workflows can have many AuditTrails
}
