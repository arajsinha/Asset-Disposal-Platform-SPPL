		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Generic Task UI",
									"targetURL": "#assetdisposaltaskui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"assetdisposaltaskui-display": {
								"semanticObject": "assetdisposaltaskui",
								"action": "display",
								"description": "Generic Task UI",
								"title": "Generic Task UI",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=assetdisposaltaskui",
									"url": sap.ui.require.toUrl("assetdisposaltaskui")
								}
							}
						}
					}
